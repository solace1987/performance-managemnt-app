...
export default function HodSubmitTable(props){
    ...
    const handleChange = (index) => e => {
        ...
        props.score.kraAreas[path[0]].kras[path[1]].kpis[path[2]].LineHeadScore = e.target.value;
        ...
        <table className = "table-auto">
            ...
            <tbody>
                ...
                {props != undefined && props.data!==undefined?props.data.map((data,index)=>{
                    ...
                    <td><input className="border text-center h-6" type ="number" onChange={handleChange(index)} value={data[2].LineHeadScore}/></td>
